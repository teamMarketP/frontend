  ...
  return (
    <div>
      ...
      <div className="flex gap-5 ">
        <div className="flex flex-col justify-between rounded-2xl min-w-[200px] text-center bg-tenn px-[22px] py-[18px]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button label="Замовити" type="submit" className="self-end" />
        </div>
      </div>
    </div>
  );
